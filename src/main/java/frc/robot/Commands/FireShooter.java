...
public class FireShooter
{
    /**
     * 
     * @param percent Percent to spin the shooter at
     * @param Reverse 0 = Fire normally, 1 = reverse to clear jam
     */

    public static void SpinShooter(double percent, Integer Reverse)
    {
        ...
        if(Reverse == 0)
        {
            right_shooter.set(percent);
            left_shooter.set(-percent);
        }
        else
        {
            right_shooter.set(-1);
